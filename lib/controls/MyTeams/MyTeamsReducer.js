...
export var myTeamsReducer = function (// eslint-disable-line @typescript-eslint/explicit-function-return-type
state, action // eslint-disable-line @typescript-eslint/no-explicit-any
) {
    switch (action.type) {
