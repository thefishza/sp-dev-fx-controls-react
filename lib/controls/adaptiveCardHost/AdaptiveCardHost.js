...
export var AdaptiveCardHost = function (props) {
    ...
    }, __spreadArray(__spreadArray([], adaptiveCardInstanceRefDependencies, true), [fluentUICustomizerContext, props.theme, props.themeType, props.hostConfig], false));
    // *****
    // set invokeAction
    useEffect(function () {
    ...
    }, __spreadArray(__spreadArray([], adaptiveCardInstanceRefDependencies, true), [props.data, props.hostConfig, props.onError], false));
    // *****
