...
var DynamicForm = /** @class */ (function (_super) {
    ...
    function DynamicForm(props) {
        ...
        _this.renderField = function (field) {
            ...
            // Default render
            return (React.createElement(DynamicField, __assign({ key: field.columnInternalName }, field, { disabled: field.disabled || isSaving, validationErrorMessage: validationErrorMessage, isSaveButtonClicked: _this.state.isSaveButtonClicked })));
        };
