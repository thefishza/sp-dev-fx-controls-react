...
var DynamicForm = /** @class */ (function (_super) {
    ...
    function DynamicForm(props) {
        ...
        _this.renderField = function (field) {
            ...
            // Default render
            return (React.createElement(DynamicField, __assign({ key: field.columnInternalName }, field, { disabled: field.disabled || isSaving, validationErrorMessage: validationErrorMessage, isSaveButtonClicked: _this.state.isSaveButtonClicked, hideValidationErrorMessages: _this.props.hideValidationErrorMessages, fieldDescriptionOptions: _this.props.fieldDescriptionOptions })));
        };
                            ...
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        if (!(field.newValue !== null && field.newValue !== undefined)) return [3 /*break*/, 4];
                                        ...
                                        if ([
                                            ...
                                            objects[fieldcolumnInternalName] = value_1;
                                        }
                                        // Choice fields
                                        if (fieldType === "Choice") {
    ...
    DynamicForm.prototype.render = function () {
        ...
        var _this = this;
        var _b, _c;
        var _d = this.state, customFormatting = _d.customFormatting, fieldCollection = _d.fieldCollection, hiddenByFormula = _d.hiddenByFormula, infoErrorMessages = _d.infoErrorMessages, isSaving = _d.isSaving;
        ...
        return (React.createElement("div", null,
            ...
            fieldCollection.length === 0 ? (React.createElement("div", null,
                ...
                footerContent,
                !this.props.disabled && (React.createElement(Stack, { className: styles.buttons, horizontal: true, tokens: stackTokens, style: this.props.buttonContainerStyle },
                    React.createElement(PrimaryButton, { disabled: isSaving, text: this.props.saveButtonLabel || strings.Save, onClick: function () { return _this.onSubmitClick(); } }),
                    React.createElement(DefaultButton, { disabled: isSaving, text: this.props.cancelButtonLabel || strings.Cancel, onClick: this.props.onCancelled }))))),
            React.createElement(Dialog, { hidden: !this.state.isValidationErrorDialogOpen, onDismiss: this.closeValidationErrorDialog, dialogContentProps: {
                    type: ((_b = this.props.validationErrorDialogProps) === null || _b === void 0 ? void 0 : _b.dialogType) ||
                        DialogType.normal,
                    title: this.getValidationErrorTitle(),
                    showCloseButton: true,
                }, modalProps: {
                    isBlocking: true,
                }, styles: ((_c = this.props.validationErrorDialogProps) === null || _c === void 0 ? void 0 : _c.dialogStyles) || {} },
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        _loop_3 = function (i, len) {
                            var field, hiddenName, termSetId, anchorId, lookupListId, lookupField, choices_1, defaultValue, value, stringValue, subPropertyValues, richText, dateFormat, principalType, cultureName, minValue, maxValue, showAsPercentage, selectedTags_1, fieldName, currentValue, numberField, userEmails, _c, _d, response, taxonomyMultiValuesList;
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0:
                                        ...
                                        if (field.FieldType === "MultiChoice") {
                                            ...
                                            currentValue = item ? item[fieldName] : null;
                                            if (currentValue === null || currentValue === void 0 ? void 0 : currentValue.results) {
