...
var DynamicField = /** @class */ (function (_super) {
    ...
    function DynamicField(props) {
        ...
        _this.getFieldComponent = function () {
            var _a, _b, _c;
            var _d = _this.props, options = _d.options, fieldTermSetId = _d.fieldTermSetId, fieldAnchorId = _d.fieldAnchorId, lookupListID = _d.lookupListID, lookupField = _d.lookupField, fieldType = _d.fieldType, defaultValue = _d.defaultValue, newValue = _d.newValue, value = _d.value, context = _d.context, disabled = _d.disabled, label = _d.label, placeholder = _d.placeholder, required = _d.required, isRichText = _d.isRichText, 
            //bingAPIKey,
            dateFormat = _d.dateFormat, firstDayOfWeek = _d.firstDayOfWeek, columnInternalName = _d.columnInternalName, principalType = _d.principalType, description = _d.description, maximumValue = _d.maximumValue, minimumValue = _d.minimumValue, customIcon = _d.customIcon, orderBy = _d.orderBy;
            ...
            var labelEl = (React.createElement("label", { className: required
                    ? styles.fieldRequired + " " + styles.fieldLabel
                    : styles.fieldLabel }, label));
            var errorText = _this.props.isSaveButtonClicked && !_this.props.hideValidationErrorMessages
                ? _this.props.validationErrorMessage || _this.getRequiredErrorText()
                : "";
            var errorTextEl = _this.props.isSaveButtonClicked &&
                !_this.props.hideValidationErrorMessages ? (React.createElement("text", { className: styles.errormessage }, errorText)) : null;
            var descriptionEl = ((_a = _this.props.fieldDescriptionOptions) === null || _a === void 0 ? void 0 : _a.disabled) === true ? null : (React.createElement("text", { className: styles.fieldDescription }, description));
            var descriptionPosition = (_c = (_b = _this.props.fieldDescriptionOptions) === null || _b === void 0 ? void 0 : _b.position) !== null && _c !== void 0 ? _c : "bottom";
            ...
            switch (fieldType) {
                ...
                case "Text":
                    return (React.createElement("div", null,
                        ...
                        React.createElement(TextField, { defaultValue: defaultValue, value: valueToDisplay, placeholder: placeholder, className: styles.fieldDisplay, onChange: function (e, newText) {
                                _this.onChange(newText);
                            }, disabled: disabled, onBlur: _this.onBlur, errorMessage: errorText }),
                    ...
                    if (isRichText) {
                        ...
                        return (React.createElement("div", { className: styles.richText },
                            React.createElement("div", { className: styles.titleContainer },
                                ...
                                labelEl),
                            descriptionPosition === "top" && descriptionEl,
                            React.createElement(RichText, { placeholder: placeholder, value: noteValue, className: styles.fieldDisplay, onChange: function (newText) {
                                    _this.onChange(newText);
                                    return newText;
                                }, isEditMode: !disabled }),
                            descriptionPosition === "bottom" && descriptionEl,
                        ...
                        return (React.createElement("div", null,
                            React.createElement("div", { className: styles.titleContainer },
                                ...
                                labelEl),
                            descriptionPosition === "top" && descriptionEl,
                            React.createElement(TextField, { defaultValue: defaultValue, value: valueToDisplay, placeholder: placeholder, className: styles.fieldDisplay, multiline: true, onChange: function (e, newText) {
                                    _this.onChange(newText);
                                }, disabled: disabled, onBlur: _this.onBlur, errorMessage: errorText }),
                            descriptionPosition === "bottom" && descriptionEl));
                    }
                case "Choice":
                    return (React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: " ".concat(styles.titleContainer) },
                            React.createElement(Icon, { className: styles.fieldIcon, iconName: customIcon !== null && customIcon !== void 0 ? customIcon : "CheckMark" }),
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(Dropdown, __assign({}, dropdownOptions, { defaultSelectedKey: valueToDisplay ? undefined : defaultValue, selectedKey: typeof valueToDisplay === "object"
                                ? valueToDisplay === null || valueToDisplay === void 0 ? void 0 : valueToDisplay.key
                                : valueToDisplay, onChange: function (e, option) {
                                _this.onChange(option, true);
                            }, onBlur: _this.onBlur, errorMessage: errorText })),
                        descriptionPosition === "bottom" && descriptionEl));
                case "MultiChoice":
                    return (React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: " ".concat(styles.titleContainer) },
                ...
                case "Location":
                    return (React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: " ".concat(styles.titleContainer) },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(LocationPicker, { context: context, disabled: disabled, placeholder: placeholder, onChange: function (newValue) {
                                _this.onChange(newValue, true);
                            }, defaultValue: valueToDisplay !== undefined ? valueToDisplay : defaultValue, errorMessage: errorText }),
                        descriptionPosition === "bottom" && descriptionEl));
                case "Lookup":
                    ...
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(ListItemPicker, { disabled: disabled, listId: lookupListID, defaultSelectedItems: lookupValue, columnInternalName: lookupField, className: styles.fieldDisplay, enableDefaultSuggestions: true, keyColumnInternalName: "Id", itemLimit: 1, onSelectedItem: function (newValue) {
                                _this.onChange(newValue, true);
                ...
                case "LookupMulti":
                    ...
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(ListItemPicker, { disabled: disabled, listId: lookupListID, defaultSelectedItems: lookupMultiValue, columnInternalName: lookupField, className: styles.fieldDisplay, enableDefaultSuggestions: true, keyColumnInternalName: "Id", itemLimit: 100, onSelectedItem: function (newValue) {
                                _this.onChange(newValue, true);
                            }, context: context }),
                        descriptionPosition === "bottom" && descriptionEl,
                        errorTextEl));
                case "Number": {
                    var customNumberErrorMessage = _this.props.isSaveButtonClicked &&
                        !_this.props.hideValidationErrorMessages
                        ? _this.getNumberErrorText()
                        : "";
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(TextField, { defaultValue: defaultValue, value: valueToDisplay, placeholder: placeholder, className: styles.fieldDisplay, type: "Number", onChange: function (e, newText) {
                                _this.onChange(newText);
                            }, disabled: disabled, onBlur: _this.onBlur, errorMessage: errorText || customNumberErrorMessage, min: minimumValue, max: maximumValue }),
                        descriptionPosition === "bottom" && descriptionEl));
                }
                case "Currency": {
                    var customNumberErrorMessage = _this.props.isSaveButtonClicked &&
                    ...
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(TextField, { defaultValue: defaultValue, value: valueToDisplay, placeholder: placeholder, className: styles.fieldDisplay, type: "Currency", onChange: function (e, newText) {
                                _this.onChange(newText);
                            }, disabled: disabled, onBlur: _this.onBlur, errorMessage: errorText || customNumberErrorMessage, min: minimumValue, max: maximumValue }),
                        descriptionPosition === "bottom" && descriptionEl));
                }
                case "DateTime":
                    return (React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        dateFormat === "DateOnly" && (React.createElement(DatePicker, { placeholder: placeholder, className: styles.pickersContainer, formatDate: function (date) {
                                return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName);
                            }, value: valueToDisplay !== undefined ? valueToDisplay : defaultValue, onSelectDate: function (newDate) {
                                _this.onChange(newDate, true);
                            }, disabled: disabled, firstDayOfWeek: firstDayOfWeek })),
                        dateFormat === "DateTime" && (React.createElement(DateTimePicker, { key: columnInternalName, placeholder: placeholder, formatDate: function (date) {
                                return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName);
                            }, value: valueToDisplay !== undefined ? valueToDisplay : defaultValue, onChange: function (newDate) {
                                _this.onChange(newDate, true);
                            }, disabled: disabled, firstDayOfWeek: firstDayOfWeek })),
                        descriptionPosition === "bottom" && descriptionEl,
                        errorTextEl));
                case "Boolean":
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(Toggle, { className: styles.fieldDisplay, checked: valueToDisplay !== undefined ? valueToDisplay : defaultValue, onText: strings.Yes, offText: strings.No, onChange: function (e, checkedvalue) {
                                _this.onChange(checkedvalue, true);
                            }, disabled: disabled }),
                        descriptionPosition === "bottom" && descriptionEl,
                        errorTextEl));
                case "User": {
                    var userValue = Boolean(changedValue)
                        ? changedValue.map(function (cv) { return cv.secondaryText; })
                        : value
                            ? value
                            : defaultValue;
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        descriptionPosition === "top" && descriptionEl,
                        React.createElement(PeoplePicker, { placeholder: placeholder, defaultSelectedUsers: userValue, peoplePickerCntrlclassName: styles.fieldDisplay, context: peoplePickerContext, personSelectionLimit: 1, showtooltip: false, showHiddenInUI: false, principalTypes: principalType === "PeopleOnly"
                                ? [PrincipalType.User]
                                : [
                                    PrincipalType.User,
                                ...
                                ], resolveDelay: 1000, onChange: function (items) {
                                _this.onChange(items, true);
                            }, disabled: disabled }),
                        descriptionPosition === "bottom" && descriptionEl,
                        errorTextEl));
                }
                ...
                case "URL":
                    return (React.createElement("div", null,
                        ...
                        React.createElement(Stack, { tokens: { childrenGap: 4 } },
                            React.createElement(TextField, { defaultValue: defaultValue ? defaultValue.Url : "", value: valueToDisplay ? valueToDisplay.Url : undefined, placeholder: strings.DynamicFormEnterURLPlaceholder, className: styles.fieldDisplayNoPadding, onChange: function (e, newText) {
                                    _this.onURLChange(newText, true);
                                }, disabled: disabled, onBlur: _this.onBlur }),
                            React.createElement(TextField, { defaultValue: defaultValue ? defaultValue.Description : "", value: valueToDisplay ? valueToDisplay.Description : undefined, placeholder: strings.DynamicFormEnterDescriptionPlaceholder, className: styles.fieldDisplayNoPadding, onChange: function (e, newText) {
                                    _this.onURLChange(newText, false);
                                }, disabled: disabled })),
                        descriptionPosition === "bottom" && descriptionEl,
                        errorTextEl));
                case "Thumbnail":
                            ...
                            React.createElement("div", { className: styles.thumbnailFieldButtons },
                                React.createElement(FilePicker, { buttonClassName: styles.fieldDisplay, 
                                    ...
                                    accepts: [
                                        ...
                                        ".jxr",
                                        ".svg",
                                    ], buttonLabel: hasImage ? undefined : "Add an image", buttonIcon: hasImage ? "Edit" : "FileImage", onSave: _this.saveIntoSharePoint, onChange: _this.saveIntoSharePoint, context: context, disabled: disabled, hideLocalMultipleUploadTab: true, hideOneDriveTab: true, hideStockImages: true, hideWebSearchTab: true }),
                                hasImage && (React.createElement(ActionButton, { disabled: disabled, iconProps: {
                                        iconName: "Delete",
        ...
        _this.onURLChange = function (value, isUrl) {
            ...
            var currValue = _this.state.changedValue ||
                defaultValue || {
                Url: "",
                Description: "",
            };
        ...
        _this.onBlur = function () {
            if (_this.state.changedValue === null && _this.props.defaultValue === "") {
        ...
        _this.getRequiredErrorText = function () {
            var changedValue = _this.state.changedValue;
            var _a = _this.props, value = _a.value, newValue = _a.newValue, required = _a.required;
            if (newValue === undefined) {
                return required &&
                    (changedValue === undefined ||
                        changedValue === "" ||
                        changedValue === null ||
                        _this.isEmptyArray(changedValue)) &&
                    (value === undefined ||
                        value === "" ||
                        value === null ||
        ...
        _this.getNumberErrorText = function () {
            var _a;
            var changedValue = _this.state.changedValue;
            var _b = _this.props, cultureName = _b.cultureName, fieldType = _b.fieldType, maximumValue = _b.maximumValue, minimumValue = _b.minimumValue, showAsPercentage = _b.showAsPercentage, value = _b.value, newValue = _b.newValue, required = _b.required;
            if (required &&
                newValue !== undefined &&
                (changedValue === undefined ||
                    changedValue === "" ||
            ...
            var minValue = minimumValue !== undefined && minimumValue !== -Number.MAX_VALUE
                ? minimumValue
                : undefined;
            var maxValue = maximumValue !== undefined && maximumValue !== Number.MAX_VALUE
                ? maximumValue
                : undefined;
            ...
            if (fieldType === "Currency" && cultureName) {
                ...
                if (minValue)
                    minValueCur = Intl.NumberFormat(cultureName, {
                        style: "currency",
                        currency: CurrencyMap[countryCode],
                    }).format(minValue);
                if (maxValue)
                    maxValueCur = Intl.NumberFormat(cultureName, {
                        style: "currency",
                        currency: CurrencyMap[countryCode],
                    }).format(maxValue);
            }
                ...
                if ((changedValue === "" || changedValue === null) && value !== null) {
                    ...
                    selectedItemArr_1 = !changedValue
                        ...
                        : Array.isArray(changedValue)
                            ? __spreadArray([], changedValue, true) : [changedValue];
                }
                if (item.selected) {
        ...
        _this.state = {
            changedValue: props.defaultValue !== undefined ||
                props.defaultValue !== "" ||
                props.defaultValue !== null ||
                !_this.isEmptyArray(props.defaultValue)
                ? props.defaultValue
                : null,
        };
        return _this;
    ...
    DynamicField.prototype.isEmptyArray = function (value) {
