                ...
                case "Boolean":
                    return (React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        React.createElement(Toggle, { className: styles.fieldDisplay, defaultChecked: defaultValue, checked: valueToDisplay !== undefined ? valueToDisplay : defaultValue, onText: strings.Yes, offText: strings.No, onChange: function (e, checkedvalue) {
