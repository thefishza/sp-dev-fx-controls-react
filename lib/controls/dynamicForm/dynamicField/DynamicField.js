...
var DynamicField = /** @class */ (function (_super) {
    ...
    function DynamicField(props) {
        ...
        _this.getFieldComponent = function () {
            ...
            var errorText = _this.props.isSaveButtonClicked
                ? _this.props.validationErrorMessage || _this.getRequiredErrorText()
                : "";
            var errorTextEl = _this.props.isSaveButtonClicked ? (React.createElement("text", { className: styles.errormessage }, errorText)) : null;
