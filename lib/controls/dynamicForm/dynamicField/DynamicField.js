...
var DynamicField = /** @class */ (function (_super) {
    ...
    function DynamicField(props) {
        ...
        _this.getFieldComponent = function () {
            ...
            var labelEl = React.createElement("label", { className: (required) ? styles.fieldRequired + ' ' + styles.fieldLabel : styles.fieldLabel }, label);
                ...
                case 'Choice':
                    return React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: "".concat(styles.labelContainer, " ").concat(styles.titleContainer) },
                            ...
                            labelEl),
                        React.createElement(Dropdown, __assign({}, dropdownOptions, { defaultSelectedKey: valueToDisplay ? undefined : defaultValue, selectedKey: typeof valueToDisplay === "object" ? valueToDisplay === null || valueToDisplay === void 0 ? void 0 : valueToDisplay.key : valueToDisplay, onChange: function (e, option) { _this.onChange(option, true); }, onBlur: _this.onBlur, errorMessage: errorText })),
                        descriptionEl);
                case 'MultiChoice':
                    return React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: "".concat(styles.labelContainer, " ").concat(styles.titleContainer) },
                ...
                case 'DateTime':
                    return React.createElement("div", { className: styles.fieldContainer },
                        React.createElement("div", { className: styles.titleContainer },
                            ...
                            labelEl),
                        dateFormat === 'DateOnly' &&
                            React.createElement(DatePicker, { placeholder: placeholder, className: styles.pickersContainer, formatDate: function (date) { return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName); }, value: valueToDisplay !== undefined ? valueToDisplay : defaultValue, onSelectDate: function (newDate) { _this.onChange(newDate, true); }, disabled: disabled, firstDayOfWeek: firstDayOfWeek }),
                        dateFormat === 'DateTime' &&
                            React.createElement(DateTimePicker, { key: columnInternalName, placeholder: placeholder, formatDate: function (date) { return date.toLocaleDateString(context.pageContext.cultureInfo.currentCultureName); }, value: valueToDisplay !== undefined ? valueToDisplay : defaultValue, onChange: function (newDate) { _this.onChange(newDate, true); }, disabled: disabled, firstDayOfWeek: firstDayOfWeek }),
                        descriptionEl,
                        errorTextEl);
                case 'Boolean':
                    return React.createElement("div", null,
        ...
        _this.getRequiredErrorText = function () {
            var changedValue = _this.state.changedValue;
            return (changedValue === undefined || changedValue === '' || changedValue === null || _this.isEmptyArray(changedValue)) && _this.props.required ? strings.DynamicFormRequiredErrorMessage : null;
        };
        _this.getNumberErrorText = function () {
            var _a;
            var changedValue = _this.state.changedValue;
            var _b = _this.props, cultureName = _b.cultureName, fieldType = _b.fieldType, maximumValue = _b.maximumValue, minimumValue = _b.minimumValue, showAsPercentage = _b.showAsPercentage;
            if ((changedValue === undefined || changedValue === '' || changedValue === null || _this.isEmptyArray(changedValue)) && _this.props.required) {
