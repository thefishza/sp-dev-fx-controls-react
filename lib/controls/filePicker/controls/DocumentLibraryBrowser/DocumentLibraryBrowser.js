...
var DocumentLibraryBrowser = /** @class */ (function (_super) {
    ...
    DocumentLibraryBrowser.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.documentLibraryBrowserContainer },
            ...
            React.createElement(List, { className: styles.filePickerFolderCardGrid, items: lists, getItemCountForPage: this._getItemCountForPage, getPageHeight: this._getPageHeight, renderedWindowsAhead: 4, onRenderCell: this._onRenderLibraryTile })));
    };
