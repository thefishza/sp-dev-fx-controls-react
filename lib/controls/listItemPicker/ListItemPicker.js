...
var ListItemPicker = /** @class */ (function (_super) {
    ...
    function ListItemPicker(props) {
        ...
        _this.loadListItems = function (filterText) { return __awaiter(_this, void 0, void 0, function () {
            var _a, columnInternalName, keyColumnInternalName, webUrl, filter, orderBy, substringSearch, _b, field, safeListId, arrayItems, keyColumn, listItems, _i, listItems_1, item, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.props, columnInternalName = _a.columnInternalName, keyColumnInternalName = _a.keyColumnInternalName, webUrl = _a.webUrl, filter = _a.filter, orderBy = _a.orderBy, substringSearch = _a.substringSearch;
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._spservice.getListItems(filterText, safeListId, columnInternalName, field, keyColumn, webUrl, filter, substringSearch, orderBy ? orderBy : '')];
                    case 2:
                        listItems = _c.sent();
