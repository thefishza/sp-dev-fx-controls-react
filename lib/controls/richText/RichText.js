...
var RichText = /** @class */ (function (_super) {
        ...
        * Renders the "Insert Image" dialog
        ...
        _this.renderImageDialog = function () {
            return (React.createElement(Dialog, { hidden: _this.state.hideImageDialog, onDismiss: _this.closeImageDialog, dialogContentProps: {
                ...
                React.createElement(TextField, { label: strings.AddressFieldLabel, value: _this.state.insertImageUrl !== undefined ? _this.state.insertImageUrl : "", onChange: function (e, newValue) {
                        _this.setState({
        ...
        _this.handleCreateLink = function () {
            ...
            if (cursorPosition > -1) {
                var textToInsert = (_this.state.insertUrlText !== undefined && _this.state.insertUrlText !== "") ? _this.state.insertUrlText : _this.state.insertUrl;
        ...
        _this.checkImageLinkUrl = function () {
            if (_this.state.insertImageUrl !== undefined && _this.state.insertImageUrl !== "") {
                return false;
            }
            return true;
        };
    ...
    RichText.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (ref) { _this._wrapperRef = ref; }, className: css(styles.richtext && this.state.editing ? 'ql-active' : null, this.props.className || null) || null, style: style },
            renderLabel,
