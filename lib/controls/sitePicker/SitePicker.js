...
export var SitePicker = function (props) {
    ...
    var onSearchChange = React.useCallback(function (e, newSearchQuery) {
        ...
        var newFilteredSites = allSites.filter(function (s) { return s.title && s.title.toLowerCase().indexOf(loweredNewSearchQuery) !== -1; });
    ...
    var onSelectionChange = React.useCallback(function (e, item, index) {
        ...
        if (multiSelect !== false) {
            ...
            newSelectedSites = [__assign({}, item.data)];
        }
        if (onChange) {
    ...
    React.useEffect(function () {
        ...
        promise.then(function (newSites) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Dropdown, { label: label, placeholder: placeholder, options: getOptions(), selectedKey: multiSelect === false && !!sites && !!sites[0] ? sites[0].url : undefined, selectedKeys: multiSelect !== false && !!sites ? sites.map(function (s) { return s.url; }) : undefined, disabled: disabled, multiSelect: multiSelect !== false, onRenderOption: onRenderOption, onChange: onSelectionChange, notifyOnReselect: true, className: className, styles: props.styles })));
};
