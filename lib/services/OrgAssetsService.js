...
var OrgAssetsService = /** @class */ (function (_super) {
    ...
    function OrgAssetsService(context, itemsToDownloadCount) {
        ...
        _this.getListItems = function (listUrl, folderPath, acceptedFilesExtensions, nextPageQueryStringParams) { return __awaiter(_this, void 0, void 0, function () {
            var filesQueryResult, isRootSite, libName, libFullUrl, queryStringParams, restApi, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        isRootSite = this.context.pageContext.site.serverRelativeUrl === '/';
                        if (!isRootSite) {
                        ...
                        libName = folderPath.replace("".concat(this._orgAssetsLibraryServerRelativeSiteUrl, "/"), '');
                        libName = libName.split('/')[0];
                        libFullUrl = this.buildAbsoluteUrl(!isRootSite ? "".concat(this._orgAssetsLibraryServerRelativeSiteUrl, "/").concat(libName) : "".concat(this._orgAssetsLibraryServerRelativeSiteUrl).concat(libName));
                        queryStringParams = "";
        ...
        _this._parseOrgAssetsLibraryItem = function (libItem) {
            var orgAssetsLibrary = {
                ...
                iconPath: libItem.ThumbnailUrl && libItem.ThumbnailUrl.DecodedUrl ? _this.buildAbsoluteUrl("".concat(_this._orgAssetsLibraryServerRelativeSiteUrl, "/").concat(libItem.ThumbnailUrl.DecodedUrl)) : null
            };
