...
var SPPeopleSearchService = /** @class */ (function () {
    ...
    SPPeopleSearchService.prototype.searchTenant = function (siteUrl, query, maximumSuggestions, principalTypes, ensureUser, allowUnvalidated, groupId) {
        return __awaiter(this, void 0, void 0, function () {
            var userRequestUrl, searchBody, graphUserRequestUrl, graphClient, graphUserResponse, _users_2, batch, _i, _a, value, userResult, _b, _users_1, user, httpPostOptions, data, userDataResp, values, _c, values_1, value, id, userResults, e_1;
            var _this = this;
