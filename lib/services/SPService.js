...
var SPService = /** @class */ (function () {
     ...
     * Get List Items
     */
    SPService.prototype.getListItems = function (filterText, listId, internalColumnName, field, keyInternalColumnName, webUrl, filterString, substringSearch, orderBy, cacheInterval) {
        if (substringSearch === void 0) { substringSearch = false; }
        if (cacheInterval === void 0) { cacheInterval = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var webAbsoluteUrl, apiUrl, isPost, processItems, orderByStr, orderByParts, ascStr, camlQuery, filterStr, mapKey_1, cachedItems, filteredItems, data, _a, results, error_4;
            var _this = this;
                    ...
                    case 0:
                        ...
                        if (field && field.TypeAsString === 'Calculated' && SPHelper.isTextFieldType(field.ResultType)) { // for calculated fields we need to use CAML query
                            ...
                            if (orderBy) {
                                ...
                                orderByStr = "<OrderBy><FieldRef Name=\"".concat(orderByParts[0], "\" ").concat(ascStr, " />");
                            }
                            camlQuery = "<View><Query><Where>".concat(substringSearch ? '<Contains>' : '<BeginsWith>', "<FieldRef Name=\"").concat(internalColumnName, "\"/><Value Type=\"").concat(field.ResultType, "\">").concat(filterText, "</Value>").concat(substringSearch ? '</Contains>' : '</BeginsWith>', "</Where>").concat(orderByStr, "</Query></View>");
                            ...
                            apiUrl = "".concat(webAbsoluteUrl, "/_api/web/lists('").concat(listId, "')/items?$select=").concat(keyInternalColumnName || 'Id', ",").concat(internalColumnName, "&$filter=").concat(filterStr, "&$orderby=").concat(orderBy);
                        }
                            ...
                            apiUrl = "".concat(webAbsoluteUrl, "/_api/web/lists('").concat(listId, "')/items?$select=").concat(keyInternalColumnName || 'Id', ",").concat(internalColumnName, ",FieldValuesAsText/").concat(internalColumnName, "&$expand=FieldValuesAsText&$orderby=").concat(orderBy).concat(filterString ? '&$filter=' + filterString : '');
                            isPost = false;
  ...
  */
    ...
    SPService.prototype.deleteAttachment = function (fileName, listId, itemId, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var spOpts, webAbsoluteUrl, apiUrl, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    SPService.prototype.addAttachment = function (listId, itemId, fileName, file, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var fileExists, spOpts, webAbsoluteUrl, apiUrl, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
    ...
    SPService.prototype.getLookupValues = function (listId, listItemID, fieldName, lookupFieldName, webUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var webAbsoluteUrl, apiUrl, data, result, lookups_1, isArray, singleItem, error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        if (result && result[fieldName]) {
                            ...
                            if (isArray) {
                                result[fieldName].forEach(function (element) {
                                    lookups_1.push({ key: element.ID, name: element[lookupFieldName || 'Title'] });
                                });
                            }
                            //single select lookups are objects
                            else {
                                singleItem = result[fieldName];
                                lookups_1.push({ key: singleItem.ID, name: singleItem[lookupFieldName || 'Title'] });
                            }
