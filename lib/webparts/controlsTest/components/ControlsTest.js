...
var ControlsTest = /** @class */ (function (_super) {
    ...
    function ControlsTest(props) {
        ...
        _this.toggleToolbarFilter = function (filterId) {
            _this.setState(function (_a) {
                ...
                if (selectedFilters.includes(filterId)) {
                    return {
                        selectedFilters: selectedFilters.filter(function (f) { return f !== filterId; }),
                    };
                }
                else {
        ...
        _this._onRenderGridItem = function (item, _finalSize, isCompact) {
            ...
            return (React.createElement("div", { "data-is-focusable": true, role: "listitem", "aria-label": item.title },
                React.createElement(DocumentCard, { type: isCompact ? DocumentCardType.compact : DocumentCardType.normal, onClick: function (ev) {
                        return alert("You clicked on a grid item");
                    } },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement(DocumentCardActivity, { activity: item.activity, people: [
                                { name: item.name, profileImageSrc: item.profileImageSrc },
                            ] })))));
        };
    ...
    ControlsTest.prototype.render = function () {
        ...
        var groupByFields = [
            {
                name: "ListItemAllFields.Department.Label",
        ...
        return (React.createElement("div", { className: styles.controlsTest },
            ...
            React.createElement("div", { id: "DynamicFormDiv", className: styles.container, hidden: !controlVisibility.DynamicForm },
                React.createElement("div", { className: "ms-font-m" },
                    React.createElement(DynamicForm, { key: this.props.dynamicFormListId, context: this.props.context, listId: this.props.dynamicFormListId, listItemId: dynamicFormListItemId, contentTypeId: this.props.dynamicFormContentTypeId, validationErrorDialogProps: this.props.dynamicFormErrorDialogEnabled
                            ? {
                                showDialogOnValidationError: true,
                                dialogType: DialogType.largeHeader,
                                dialogStyles: { main: { maxWidth: 450 } },
                            }
                            : undefined, fieldDescriptionOptions: {
                            disabled: false,
                            position: "bottom",
                        }, returnListItemInstanceOnSubmit: true, onCancelled: function () {
                            console.log("Cancelled");
                        }, onSubmitted: function (data, item) { return __awaiter(_this, void 0, void 0, function () {
                            var itemdata;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                        ...
                        }); }, useClientSideValidation: this.props.dynamicFormClientSideValidationEnabled, useFieldValidation: this.props.dynamicFormFieldValidationEnabled, useCustomFormatting: this.props.dynamicFormCustomFormattingEnabled, hideValidationErrorMessages: true, enableFileSelection: this.props.dynamicFormFileSelectionEnabled, customIcons: dynamicFormCustomTitleIcon }))),
            React.createElement("div", { id: "TeamsDiv", className: styles.container, hidden: !controlVisibility.Teams },
                ...
                React.createElement(Stack, { styles: { root: { margin: "10px 10px 100px 10px" } }, tokens: { childrenGap: 10 } },
                    ...
                    ((_a = this.state) === null || _a === void 0 ? void 0 : _a.selectedTeam) &&
                        ((_b = this.state) === null || _b === void 0 ? void 0 : _b.selectedTeam.length) > 0 && (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { id: "TaxonomyPickerDiv", className: styles.container, hidden: !controlVisibility.TaxonomyPicker },
                React.createElement("div", { className: "ms-font-m" },
                            ...
                            actions: [
                                {
                                    ...
                                    applyToTerm: function (term) {
                                        return term &&
                                            term.Name &&
                                            term.Name.toLowerCase() === "about us";
                                    },
                                },
                    ...
                    React.createElement(TaxonomyPicker, { allowMultipleSelections: true, termsetNameOrID: "8ea5ac06-fd7c-4269-8d0d-02f541df8eb9" // id to termset that has a default sort
                        ...
                        required: true, errorMessage: "this field is required", onGetErrorMessage: function (value) {
                            return "comment errorMessage to see this one";
                        } }),
                            ...
                            actions: [
                                {
                                    ...
                                    applyToTerm: function (term) {
                                        return term && term.Name && term.Name === "internal";
                                    },
                                },
                                {
                                    title: "Hide term",
            ...
            React.createElement("div", { id: "DateTimePickerDiv", className: styles.container, hidden: !controlVisibility.DateTimePicker },
                ...
                React.createElement(DateTimePicker, { label: "DateTime Picker (restricted dates)", isMonthPickerVisible: false, showSeconds: false, onChange: function (value) { return console.log("DateTimePicker value:", value); }, placeholder: "Pick a date", restrictedDates: [
                        new Date(2024, 1, 15),
                        new Date(2024, 1, 16),
                        new Date(2024, 1, 17),
                    ] })),
            React.createElement("div", { id: "RichTextDiv", className: styles.container, hidden: !controlVisibility.RichText },
                React.createElement(RichText, { label: "My rich text field", value: this.state.richTextValue, isEditMode: this.props.displayMode === DisplayMode.Edit, onChange: function (value) {
                        _this.setState({ richTextValue: value });
                        return value;
                    } }),
                React.createElement(PrimaryButton, { text: "Reset text", onClick: function () {
                        _this.setState({ richTextValue: "test" });
                    } })),
            ...
            React.createElement("div", { id: "PeoplePickerDiv", className: styles.container, hidden: !controlVisibility.PeoplePicker },
                ...
                React.createElement(PeoplePicker, { context: this.peoplePickerContext, titleText: "People Picker with filter for '.com'", personSelectionLimit: 5, ensureUser: true, principalTypes: [
                        PrincipalType.User,
                        PrincipalType.SharePointGroup,
                        PrincipalType.SecurityGroup,
                        PrincipalType.DistributionList,
                ...
                React.createElement(PeoplePicker, { context: this.peoplePickerContext, titleText: "People Picker (Group not found)", webAbsoluteUrl: this.props.context.pageContext.site.absoluteUrl, groupName: "Team Site Visitors 123", ensureUser: true, principalTypes: [
                        ...
                        "test@tenant.onmicrosoft.com",
                    ], onChange: this._getPeoplePickerItems }),
                React.createElement(PeoplePicker, { context: this.peoplePickerContext, titleText: "People Picker (search for group)", groupName: "Team Site Visitors", principalTypes: [
                        PrincipalType.User,
                        PrincipalType.SharePointGroup,
                        PrincipalType.SecurityGroup,
                        PrincipalType.DistributionList,
                ...
                React.createElement(PeoplePicker, { context: this.peoplePickerContext, titleText: "People Picker (pre-set global users)", principalTypes: [
                        PrincipalType.User,
                        PrincipalType.SharePointGroup,
                        PrincipalType.SecurityGroup,
                        PrincipalType.DistributionList,
                        ...
                        "admin@tenant.onmicrosoft.com",
                        "test@tenant.onmicrosoft.com",
                    ], onChange: this._getPeoplePickerItems, personSelectionLimit: 2, ensureUser: true }),
                ...
                React.createElement(PeoplePicker, { context: this.peoplePickerContext, titleText: "People Picker (tenant scoped)", personSelectionLimit: 10, searchTextLimit: 5, 
                    ...
                    onChange: this._getPeoplePickerItems, showHiddenInUI: false, principalTypes: [
                        PrincipalType.User,
                        PrincipalType.SharePointGroup,
                        PrincipalType.SecurityGroup,
                        PrincipalType.DistributionList,
                    ], suggestionsLimit: 5, resolveDelay: 200, placeholder: "Select a SharePoint principal (User or Group)", onGetErrorMessage: function (items) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                ...
                React.createElement(PeoplePicker, { context: this.peoplePickerContext, titleText: "People Picker (local scoped)", webAbsoluteUrl: this.props.context.pageContext.site.absoluteUrl, personSelectionLimit: 5, 
                    ...
                    onChange: this._getPeoplePickerItems, showHiddenInUI: false, principalTypes: [
                        ...
                        PrincipalType.SecurityGroup,
                        PrincipalType.DistributionList,
                    ], suggestionsLimit: 2, resolveDelay: 200 }),
            ...
            React.createElement("div", { id: "MapDiv", className: styles.container, hidden: !controlVisibility.Map },
                React.createElement(Map, { titleText: "New map control", coordinates: { latitude: 51.507351, longitude: -0.127758 }, enableSearch: true, mapType: MapType.normal, onUpdateCoordinates: function (coordinates) {
                        return console.log("Updated location:", coordinates);
                    } })),
            ...
            React.createElement("div", { id: "FileTypeIconDiv", className: styles.container, hidden: !controlVisibility.FileTypeIcon },
                ...
                React.createElement("div", { className: "ms-font-m" },
                    ...
                    React.createElement(FileTypeIcon, { type: IconType.image, application: ApplicationType.PowerApps, size: ImageSize.medium, onClick: function (e) { return console.log("onClick on FileTypeIcon!"); }, onDoubleClick: function (e) {
                            return console.log("onDoubleClick on FileTypeIcon!");
                        }, onMouseEnter: function (e) { return console.log("onMouseEnter on FileTypeIcon!"); }, onMouseLeave: function (e) { return console.log("onMouseLeave on FileTypeIcon!"); }, onMouseOver: function (e) { return console.log("onMouseOver on FileTypeIcon!"); }, onMouseUp: function (e) { return console.log("onMouseUp on FileTypeIcon!"); } })),
                React.createElement("div", { className: "ms-font-m" },
                    "Icon size tester:",
            ...
            React.createElement("div", { id: "SitePickerDiv", className: styles.container, hidden: !controlVisibility.SitePicker },
                React.createElement("div", { className: "ms-font-m" },
                    "Site picker tester:",
                    React.createElement(SitePicker, { context: this.props.context, label: "select sites", mode: "site", allowSearch: true, multiSelect: false, onChange: function (sites) {
                            console.log(sites);
                        }, placeholder: "Select sites", searchPlaceholder: "Filter sites" }))),
            ...
            React.createElement("div", { id: "IconPickerDiv", className: styles.container, hidden: !controlVisibility.IconPicker },
                ...
                React.createElement("div", null,
                    React.createElement(IconPicker, { renderOption: "panel", onSave: function (value) {
                            console.log(value);
                        }, currentIcon: "Warning", buttonLabel: "Icon Picker" })),
                React.createElement(IconPicker, { buttonLabel: "Icon", onChange: function (iconName) {
            ...
            React.createElement("div", { id: "IFrameDialogDiv", className: styles.container, hidden: !controlVisibility.IFrameDialog },
                React.createElement("div", { className: "ms-font-m" },
                    ...
                    React.createElement(PrimaryButton, { text: "Open iframe Dialog", onClick: function () {
                            _this.setState({ iFrameDialogOpened: true });
                        } }),
                    React.createElement(IFrameDialog, { url: iframeUrl, iframeOnLoad: function (iframe) {
                            console.log("iframe loaded");
                        }, hidden: !this.state.iFrameDialogOpened, onDismiss: function () {
                            _this.setState({ iFrameDialogOpened: false });
                        }, modalProps: {
                            isBlocking: true,
                            styles: {
                                root: {
            ...
            React.createElement("div", { id: "IFramePanelDiv", className: styles.container, hidden: !controlVisibility.IFramePanel },
                React.createElement("div", { className: "ms-font-m" },
                    "iframe Panel tester:",
                    React.createElement(PrimaryButton, { text: "Open iframe Panel", onClick: function () {
                            _this.setState({ iFramePanelOpened: true });
                        } }),
                    React.createElement(IFramePanel, { url: iframeUrl, type: PanelType.medium, 
                        //  height="300px"
                        headerText: "iframe panel title", closeButtonAriaLabel: "Close", isOpen: this.state.iFramePanelOpened, onDismiss: function () {
                            _this.setState({ iFramePanelOpened: false });
            ...
            React.createElement("div", { id: "FolderPickerDiv", className: styles.container, hidden: !controlVisibility.FolderPicker },
                React.createElement(FolderPicker, { context: this.props.context, rootFolder: {
                        Name: "Documents",
                        ServerRelativeUrl: "".concat(this.props.context.pageContext.web.serverRelativeUrl === "/"
                            ? ""
                            : this.props.context.pageContext.web.serverRelativeUrl, "/Shared Documents"),
            ...
            React.createElement("div", { id: "CarouselDiv", className: styles.container, hidden: !controlVisibility.Carousel },
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(Carousel, { buttonsLocation: CarouselButtonsLocation.center, buttonsDisplay: CarouselButtonsDisplay.buttonsOnly, contentContainerStyles: styles.carouselImageContent, 
                        ...
                        ], onMoveNextClicked: function (index) {
                            /*  console.log(`Next button clicked: ${index}`); */
                        }, onMovePrevClicked: function (index) {
            ...
            React.createElement("div", { id: "FilePickerDiv", className: styles.container, hidden: !controlVisibility.FilePicker },
                React.createElement("div", null,
                    ...
                    React.createElement(TextField, { label: "Default SiteFileTab Folder", onChange: debounce(function (ev, newVal) {
                            _this.setState({ filePickerDefaultFolderAbsolutePath: newVal });
                        }, 500), styles: { root: { marginBottom: 10 } } }),
                    React.createElement(FilePicker, { bingAPIKey: "<BING API KEY>", 
                        ...
                        buttonLabel: "Add File", buttonIconProps: {
                            iconName: "Add",
                            styles: { root: { fontSize: 42 } },
                        }, onSave: this._onFilePickerSave, onChange: function (filePickerResult) {
                            console.log(filePickerResult);
                        }, context: this.props.context, hideRecentTab: false, includePageLibraries: true, checkIfFileExists: false }),
                    this.state.filePickerResult && (React.createElement("div", null,
                        React.createElement("div", null,
                            "FileName: ",
                ...
                React.createElement("div", null,
                    ...
                    React.createElement(FilePicker, { bingAPIKey: "<BING API KEY>", 
                        ...
                        buttonLabel: "Upload image", buttonIcon: "FileImage", onSave: this._onFilePickerSave, onChange: function (filePickerResult) {
                            console.log(filePickerResult);
                        }, context: this.props.context, hideRecentTab: false, renderCustomUploadTabContent: function () { return (React.createElement(FolderExplorer, { context: _this.props.context, rootFolder: _this.rootFolder, defaultFolder: _this.rootFolder, onSelect: _this._onFolderSelect, canCreateFolders: true })); } })),
            ...
            React.createElement("div", { id: "TreeViewDiv", className: styles.container, hidden: !controlVisibility.TreeView },
                ...
                React.createElement(PrimaryButton, { onClick: function () {
                        _this.setState({ treeViewSelectedKeys: [] });
                    } }, "Clear selection")),
            ...
            React.createElement("div", { id: "FieldCollectionDataDiv", className: styles.container, hidden: !controlVisibility.FieldCollectionData },
                React.createElement(FieldCollectionData, { key: "FieldCollectionData", label: "Fields Collection", itemsPerPage: 3, manageBtnLabel: "Manage", onChanged: function (value) {
                        console.log(value);
                    }, panelHeader: "Manage values", enableSorting: true, panelProps: { type: PanelType.custom, customWidth: "98vw" }, fields: [
                        {
                            id: "Field1",
                            title: "String field",
                        ...
                        },
                        {
                            id: "Field5",
                            title: "People picker",
                            type: CustomCollectionFieldType.peoplepicker,
                            required: true,
                            minimumUsers: 2,
                            minimumUsersMessage: "2 Users is the minimum",
                            maximumUsers: 3,
                        },
                        {
                            id: "Field6",
                        ...
                        },
                        {
                            id: "Field8",
                            title: "Date field",
                            type: CustomCollectionFieldType.date,
                            ...
                            body: [
                                {
                                    id: "t1",
                                    title: "Tab 1",
                                    content: (React.createElement(Flex, { vAlign: "center", hAlign: "center", styles: {
                                            height: "100%",
                                            border: "1px dashed rgb(179, 176, 173)",
                                        } },
            ...
            React.createElement("div", { id: "AnimatedDialogDiv", className: styles.container, hidden: !controlVisibility.animatedDialog },
                ...
                React.createElement(PrimaryButton, { text: "Show animated dialog", onClick: function () {
                        _this.setState({ showAnimatedDialog: true });
                    } }),
                React.createElement(AnimatedDialog, { hidden: !this.state.showAnimatedDialog, onDismiss: function () {
                        _this.setState({ showAnimatedDialog: false });
                    }, dialogContentProps: animatedDialogContentProps, modalProps: animatedModalProps },
                ...
                React.createElement("br", null),
                React.createElement(PrimaryButton, { text: "Show animated dialog with icon", onClick: function () {
                        _this.setState({ showCustomisedAnimatedDialog: true });
                    } }),
                React.createElement(AnimatedDialog, { hidden: !this.state.showCustomisedAnimatedDialog, onDismiss: function () {
                        _this.setState({ showCustomisedAnimatedDialog: false });
                    }, dialogContentProps: customizedAnimatedDialogContentProps, modalProps: customizedAnimatedModalProps, dialogAnimationInType: "fadeInDown", dialogAnimationOutType: "fadeOutDown", iconName: "UnknownSolid", iconAnimationType: "zoomInDown", showAnimatedDialogFooter: true, okButtonText: "Yes", cancelButtonText: "No", onOkClick: function () { return timeout(1500); }, onSuccess: function () {
                        _this.setState({ showCustomisedAnimatedDialog: false });
                ...
                React.createElement(AnimatedDialog, { hidden: !this.state.showSuccessDialog, onDismiss: function () {
                        _this.setState({ showSuccessDialog: false });
                    }, dialogContentProps: successDialogContentProps, modalProps: customizedAnimatedModalProps, iconName: "CompletedSolid" },
                    React.createElement("div", { className: styles.dialogContent },
                ...
                React.createElement(AnimatedDialog, { hidden: !this.state.showErrorDialog, onDismiss: function () {
                        _this.setState({ showErrorDialog: false });
                    }, dialogContentProps: errorDialogContentProps, modalProps: customizedAnimatedModalProps, iconName: "StatusErrorFull" },
                    React.createElement("div", { className: styles.dialogContent },
            ...
            React.createElement("div", { id: "LocationPickerDiv", className: styles.container, hidden: !controlVisibility.LocationPicker },
                React.createElement(LocationPicker, { context: this.props.context, label: "Location", onChange: function (locValue) {
            ...
            React.createElement("div", { id: "AdaptiveCardDesignerHostDiv", className: styles.container, hidden: !controlVisibility.adaptiveCardDesignerHost },
                ...
                React.createElement(AdaptiveCardDesignerHost, { headerText: "Adaptive Card Designer", buttonText: "Open Designer", card: {
                        $schema: "http://adaptivecards.io/schemas/adaptive-card.json",
                        type: "AdaptiveCard",
                        version: "1.5",
                        body: [
                    ...
                    }, data: undefined, context: this.props.context, theme: this.props.themeVariant, onSave: function (payload) { return alert(JSON.stringify(payload)); }, snippets: [
                        {
                            name: "Persona",
                            category: "Snippets",
                            payload: {
    ...
    ControlsTest.prototype.renderCustomTreeItem = function (item) {
        return (React.createElement("span", null,
            item.iconProps && (React.createElement("i", { className: "ms-Icon ms-Icon--" + item.iconProps.iconName, style: { paddingRight: "4px" } })),
            item.label));
    };
