...
> {
  constructor(props: IDynamicFieldProps) {
    ...
    this.state = {
      changedValue:
        ...
        !this.isEmptyArray(props.defaultValue)
          ? props.defaultValue
          : null,
    };
  }
  ...
  public render(): JSX.Element {
    try {
      return (
        <div className={styles.FieldEditor}>{this.getFieldComponent()}</div>
      );
    } catch (error) {
        ...
        return (
          <div className={styles.fieldContainer}>
            ...
            >
              <Icon
                className={styles.fieldIcon}
                iconName={customIcon ?? "MultiSelect"}
              />
              {labelEl}
            </div>
            <Dropdown
        ...
        return (
          <div>
            <div className={styles.titleContainer}>
              <Icon
                className={styles.fieldIcon}
                iconName={customIcon ?? "NumberField"}
              />
              {labelEl}
            </div>
            <TextField
        ...
        return (
          <div>
            <div className={styles.titleContainer}>
              <Icon
                className={styles.fieldIcon}
                iconName={customIcon ?? "AllCurrency"}
              />
              {labelEl}
            </div>
            <TextField
        ...
        return (
          <div>
            <div className={styles.titleContainer}>
              <Icon
                className={styles.fieldIcon}
                iconName={customIcon ?? "CheckboxComposite"}
              />
              {labelEl}
            </div>
            <Toggle
              ...
              onChange={(e, checkedvalue) => {
                this.onChange(checkedvalue, true);
              }}
              disabled={disabled}
            />
            {descriptionEl}
          ...
          <div>
            ...
            <Stack tokens={{ childrenGap: 4 }}>
              ...
              <TextField
                ...
                className={styles.fieldDisplayNoPadding}
                onChange={(e, newText) => {
                  this.onURLChange(newText, false);
                }}
                disabled={disabled}
              />
            </Stack>
      ...
      case "Thumbnail":
        return (
          <div>
            ...
            >
              {hasImage && <Image src={changedValue} height={60} />}
        ...
        return (
          <div className={styles.fieldContainer}>
            <div className={styles.titleContainer}>
              <Icon
                className={styles.fieldIcon}
                iconName={customIcon ?? "BulletedTreeList"}
              />
              {labelEl}
            </div>
  ...
  private onDeleteImage = (): void => {
    const { onChanged, columnInternalName } = this.props;
  ...
  private onURLChange = (value: string, isUrl: boolean): void => {
    const { defaultValue, onChanged, columnInternalName } = this.props;

    let currValue = this.state.changedValue ||
      defaultValue || {
        Url: "",
        Description: "",
      };
  ...
  private onChange = (value: any, callValidation = false): void => {
    ...
    if (newValue === undefined) {
      return required &&
        (changedValue === undefined ||
          changedValue === "" ||
          changedValue === null ||
          this.isEmptyArray(changedValue)) &&
        (value === undefined ||
          value === "" ||
          value === null ||
  ...
  private getNumberErrorText = (): string => {
    ...
    let minValue =
      minimumValue !== undefined && minimumValue !== -Number.MAX_VALUE
        ? minimumValue
        : undefined;
    let maxValue =
      maximumValue !== undefined && maximumValue !== Number.MAX_VALUE
        ? maximumValue
        : undefined;
