...
const sampleGridData: any[] = [
  {
    ...
    profileImageSrc:
      "https://robohash.org/blanditiisadlabore.png?size=50x50&set=set1",
    location: "SharePoint",
    activity: "3/13/2019",
  },
  {
    ...
    profileImageSrc:
      "https://robohash.org/delectusetcorporis.bmp?size=50x50&set=set1",
    location: "SharePoint",
    activity: "6/29/2019",
  },
  {
    ...
    name: "Seward Keith",
    profileImageSrc:
      "https://robohash.org/asperioresautquasi.jpg?size=50x50&set=set1",
    location: "PowerApps",
    activity: "12/31/2018",
  },
  {
    ...
    profileImageSrc:
      "https://robohash.org/velnammolestiae.png?size=50x50&set=set1",
    location: "SharePoint",
    activity: "11/20/2018",
  },
  {
    ...
    name: "Boyce Batstone",
    profileImageSrc:
      "https://robohash.org/nulladistinctiomollitia.jpg?size=50x50&set=set1",
    location: "Flow",
    activity: "5/26/2019",
  },
];
...
> {
  ...
  private carouselElements = [
    <div id="1" key="1">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis a mattis
      libero, nec consectetur neque. Suspendisse potenti. Fusce ultrices
      faucibus consequat. Suspendisse ex diam, ullamcorper sit amet justo ac,
      accumsan congue neque. Vestibulum aliquam mauris non justo convallis, id
      molestie purus sodales. Maecenas scelerisque aliquet turpis, ac efficitur
      ex iaculis et. Vivamus finibus mi eget urna tempor, sed porta justo
      tempus. Vestibulum et lectus magna. Integer ante felis, ullamcorper
      venenatis lectus ac, vulputate pharetra magna. Morbi eget nisl tempus,
      viverra diam ac, mollis tortor. Nam odio ex, viverra bibendum mauris
      vehicula, consequat suscipit ligula. Nunc sed ultrices augue, eu tincidunt
      diam.
    </div>,
    <div id="2" key="2">
      Quisque metus lectus, facilisis id consectetur ac, hendrerit eget quam.
      Interdum et malesuada fames ac ante ipsum primis in faucibus. Ut faucibus
      posuere felis vel efficitur. Maecenas et massa in sem tincidunt finibus.
      Duis sit amet bibendum nisi. Vestibulum pretium pretium libero, vel
      tincidunt sem vestibulum sed. Interdum et malesuada fames ac ante ipsum
      primis in faucibus. Proin quam lorem, venenatis id bibendum id, tempus eu
      nibh. Sed tristique semper ligula, vitae gravida diam gravida vitae. Donec
      eget posuere mauris, pharetra semper lectus.
    </div>,
    <div id="3" key="3">
      Pellentesque tempor et leo at tincidunt. Vivamus et leo sed eros vehicula
      mollis vitae in dui. Duis posuere sodales enim ut ultricies. Cras in
      venenatis nulla. Ut sed neque dignissim, sollicitudin tellus convallis,
      placerat leo. Aliquam vestibulum, leo pharetra sollicitudin pretium, ipsum
      nisl tincidunt orci, in molestie ipsum dui et mi. Praesent aliquam
      accumsan risus sed bibendum. Cras consectetur elementum turpis, a mollis
      velit gravida sit amet. Praesent non augue cursus, varius justo at,
      molestie lorem. Nulla cursus tellus quis odio congue elementum. Vivamus
      sit amet quam nec lectus hendrerit blandit. Duis ac condimentum sem. Morbi
      hendrerit elementum purus, non facilisis arcu bibendum vitae. Vivamus
      commodo tristique euismod.
    </div>,
    <div id="4" key="4">
      Proin semper egestas porta. Nullam risus nisl, auctor ac hendrerit in,
      dapibus quis ex. Quisque vitae nisi quam. Etiam vel sapien ut libero
      ornare rhoncus nec vestibulum dolor. Curabitur lacinia aliquam arcu. Proin
      ultrices risus velit, in vehicula tellus vehicula at. Sed ultrices et
      felis fringilla ultricies.
    </div>,
    <div id="5" key="5">
      Donec orci lorem, imperdiet eu nisi sit amet, condimentum scelerisque
      tortor. Etiam nec lacinia dui. Duis non turpis neque. Sed pellentesque a
      erat et accumsan. Pellentesque elit odio, elementum nec placerat nec,
      ornare in tortor. Suspendisse gravida magna maximus mollis facilisis. Duis
      odio libero, finibus ac suscipit sed, aliquam et diam. Aenean posuere
      lacus ex. Donec dapibus, sem ac luctus ultrices, justo libero tempor eros,
      vitae lacinia ex ante non dolor. Curabitur condimentum, ligula id pharetra
      dictum, libero libero ullamcorper nunc, eu blandit sem arcu ut felis.
      Nullam lacinia dapibus auctor.
    </div>,
  ];
  ...
  private toggleToolbarFilter = (filterId: string) => {
    this.setState(({ selectedFilters }) => {
      if (selectedFilters.includes(filterId)) {
        return {
          selectedFilters: selectedFilters.filter((f) => f !== filterId),
        };
      } else {
      ...
      >
        <DocumentCard
          ...
          onClick={(ev: React.SyntheticEvent<HTMLElement>) =>
            alert("You clicked on a grid item")
          }
        >
      ...
      <div className={styles.controlsTest}>
        <div className={styles.container}>
          ...
          <div className={`${styles.row} ${styles.controlFiltersContainer}`}>
            <PrimaryButton
              text="Open Web Part Settings"
              iconProps={{ iconName: "Settings" }}
              onClick={this.props.onOpenPropertyPane}
            />
          </div>
        </div>
        <div
          ...
          hidden={!controlVisibility.WebPartTitle}
        >
          <WebPartTitle
            ...
            moreLink={
              <Link href="https://pnp.github.io/sp-dev-fx-controls-react/">
                See all
              </Link>
            }
          />
        ...
        <div
          id="DynamicFormDiv"
          className={styles.container}
          hidden={!controlVisibility.DynamicForm}
        >
        ...
        <div
          id="TeamsDiv"
          className={styles.container}
          hidden={!controlVisibility.Teams}
        >
        ...
        <div
          id="accessibleAccordionDiv"
          className={styles.container}
          hidden={!controlVisibility.accessibleAccordion}
        >
          <AccessibleAccordion
            allowZeroExpanded
          ...
          {sampleItems.map((item, index) => (
            ...
            >
              <div className={"itemContent"}>
                ...
                <div
                  className={"itemIndex"}
                >{`Langue :  ${item.Langue.Nom}`}</div>
              </div>
            </Accordion>
          ))}
        </div>
        <div
          id="TaxonomyPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.TaxonomyPicker}
        >
          <div className="ms-font-m">
            Services tester:
            <TaxonomyPicker
                ...
                actions: [
                  {
                    ...
                    applyToTerm: (term: ITerm) =>
                      term && term.Name && term.Name === "internal",
                  },
                  {
                    title: "Hide term",
                    id: "hideTerm",
        ...
        <div
          id="DateTimePickerDiv"
          className={styles.container}
          hidden={!controlVisibility.DateTimePicker}
        >
          <DateTimePicker
            label="DateTime Picker (unspecified = date and time)"
          ...
          />
          <DateTimePicker
            label="DateTime Picker 12-hour clock"
            showSeconds={true}
            onChange={(value) => console.log("DateTimePicker value:", value)}
          ...
          />
          <DateTimePicker
            label="DateTime Picker 24-hour clock"
            showSeconds={true}
            timeConvention={TimeConvention.Hours24}
            onChange={(value) => console.log("DateTimePicker value:", value)}
          />
          <DateTimePicker
            label="DateTime Picker no seconds"
            value={new Date()}
            onChange={(value) => console.log("DateTimePicker value:", value)}
          />
          <DateTimePicker
          ...
          />
          <DateTimePicker
            label="DateTime Picker dropdown"
            showSeconds={true}
            timeDisplayControlType={TimeDisplayControlType.Dropdown}
            value={new Date()}
            onChange={(value) => console.log("DateTimePicker value:", value)}
          ...
          <DateTimePicker
            label="DateTime Picker (restricted dates)"
            isMonthPickerVisible={false}
            showSeconds={false}
            onChange={(value) => console.log("DateTimePicker value:", value)}
            placeholder="Pick a date"
        ...
        <div
          id="RichTextDiv"
          className={styles.container}
          hidden={!controlVisibility.RichText}
        >
          ...
          <PrimaryButton
            text="Reset text"
            onClick={() => {
              this.setState({ richTextValue: "test" });
            }}
          />
        </div>
        <div
          id="PlaceholderDiv"
          className={styles.container}
          hidden={!controlVisibility.Placeholder}
        >
          <Placeholder
            iconName="Edit"
            iconText="Configure your web part"
            description={(defaultClassNames) => (
              <span className={defaultClassNames}>
        ...
        <div
          id="PeoplePickerDiv"
          className={styles.container}
          hidden={!controlVisibility.PeoplePicker}
        >
          <PeoplePicker
        ...
        <div
          id="DragDropFilesDiv"
          className={styles.container}
          hidden={!controlVisibility.DragDropFiles}
        >
        ...
        <div
          id="ListViewDiv"
          className={styles.container}
          hidden={!controlVisibility.ListView}
        >
          <ListView
        ...
        <div
          id="ChartControlDiv"
          className={styles.container}
          hidden={!controlVisibility.ChartControl}
        >
          <ChartControl
            type={ChartType.Bar}
            data={{
        ...
        <div
          id="MapDiv"
          className={styles.container}
          hidden={!controlVisibility.Map}
        >
          <Map
            titleText="New map control"
        ...
        <div
          id="ModernAudioDiv"
          className={styles.container}
          hidden={!controlVisibility.ModernAudio}
        >
          <ModernAudio
            audioUrl="https://www.winhistory.de/more/winstart/mp3/vista.mp3"
            label="Audio Control"
            labelPosition={ModernAudioLabelPosition.BottomCenter}
          />
        </div>
        <div
          id="FileTypeIconDiv"
          className={styles.container}
          hidden={!controlVisibility.FileTypeIcon}
        >
          ...
          <div className="ms-font-m">
            ...
            <FileTypeIcon
              type={IconType.image}
              path="https://contoso.sharepoint.com/documents/filename.pdf"
            />
          </div>
          <div className="ms-font-m">
            ...
            <FileTypeIcon
              ...
              onDoubleClick={(e) =>
                console.log("onDoubleClick on FileTypeIcon!")
              }
        ...
        <div
          id="SecurityTrimmedControlDiv"
          className={styles.container}
          hidden={!controlVisibility.SecurityTrimmedControl}
        >
          <SecurityTrimmedControl
            context={this.props.context}
            ...
            noPermissionsControl={<p>You do not have permissions.</p>}
          >
        ...
        <div
          id="SitePickerDiv"
          className={styles.container}
          hidden={!controlVisibility.SitePicker}
        >
          <div className="ms-font-m">
            Site picker tester:
            <SitePicker
        ...
        <div
          id="ListPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.ListPicker}
        >
          <div className="ms-font-m">
            List picker tester:
            <ListPicker
        ...
        <div
          id="ListItemPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.ListItemPicker}
        >
          <div className="ms-font-m">
        ...
        <div
          id="ListItemCommentsDiv"
          className={styles.container}
          hidden={!controlVisibility.ListItemComments}
        >
          <div className="ms-font-m">
        ...
        <div
          id="ViewPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.ViewPicker}
        >
          <div className="ms-font-m">
            View picker tester:
            <ViewPicker
        ...
        <div
          id="FieldPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.FieldPicker}
        >
          <div className="ms-font-m">
            Field picker tester:
            <FieldPicker
        ...
        <div
          id="IconPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.IconPicker}
        >
          <div>Icon Picker</div>
          <div>
            <IconPicker
        ...
        <div
          id="ComboBoxListItemPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.ComboBoxListItemPicker}
        >
          <div className="ms-font-m">
            ComboBoxListItemPicker:
            <ComboBoxListItemPicker
              listId={this.state.comboBoxListItemPickerListId}
            ...
            <PrimaryButton
              ...
              onClick={() => {
                this.setState({
                  comboBoxListItemPickerListId:
                    "71210430-8436-4962-a14d-5525475abd6b",
                });
              }}
            />
            <PrimaryButton
              text="Change default items"
              onClick={() => {
                this.setState({
        ...
        <div
          id="IFrameDialogDiv"
          className={styles.container}
          hidden={!controlVisibility.IFrameDialog}
        >
          <div className="ms-font-m">
        ...
        <div
          id="IFramePanelDiv"
          className={styles.container}
          hidden={!controlVisibility.IFramePanel}
        >
          <div className="ms-font-m">
            iframe Panel tester:
            <PrimaryButton
              ...
              onClick={() => {
                this.setState({ iFramePanelOpened: true });
              }}
            />
            <IFramePanel
              url={iframeUrl}
        ...
        <div
          id="FolderPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.FolderPicker}
        >
          <FolderPicker
            context={this.props.context}
            rootFolder={{
        ...
        <div
          id="CarouselDiv"
          className={styles.container}
          hidden={!controlVisibility.Carousel}
        >
          <div>
          ...
          <div>
            ...
            <Carousel
              ...
              element={[
                ...
                {
                  imageSrc:
                    "https://www.telegraph.co.uk/content/dam/science/2018/06/20/stonehenge-2326750_1920_trans%2B%2BZgEkZX3M936N5BQK4Va8RWtT0gK_6EfZT336f62EI5U.jpg",
                  title: "Stonehenge",
          ...
          <div>
            ...
            <Carousel element={this.carouselElements} contentHeight={200} />
          </div>
        </div>
        <div
          id="SiteBreadcrumbDiv"
          className={styles.container}
          hidden={!controlVisibility.SiteBreadcrumb}
        >
        ...
        <div
          id="FilePickerDiv"
          className={styles.container}
          hidden={!controlVisibility.FilePicker}
        >
          <div>
            <h3>File Picker</h3>
            <TextField
              label="Default SiteFileTab Folder"
              onChange={debounce((ev, newVal) => {
                this.setState({ filePickerDefaultFolderAbsolutePath: newVal });
              }, 500)}
            ...
            {this.state.filePickerResult && (
              <div>
                <div>FileName: {this.state.filePickerResult[0].fileName}</div>
                <div>File size: {this.state.filePickerResult[0].fileSize}</div>
              </div>
            )}
          </div>
        ...
        <div
          id="ProgressDiv"
          className={styles.container}
          hidden={!controlVisibility.Progress}
        >
          <Progress
            title={"Progress Test"}
          ...
          <PrimaryButton
            text={"Start Progress"}
            onClick={this._startProgress}
          />
        </div>
        <div
          id="GridLayoutDiv"
          className={styles.container}
          hidden={!controlVisibility.GridLayout}
        >
          <div className="ms-font-l">Grid Layout</div>
          <GridLayout
            ariaLabel={
              "List of content, use right and left arrow keys to navigate, arrow down to access details."
            }
        ...
        <div
          id="FolderExplorerDiv"
          className={styles.container}
          hidden={!controlVisibility.FolderExplorer}
        >
          <FolderExplorer
            context={this.props.context}
            rootFolder={{
        ...
        <div
          id="TreeViewDiv"
          className={styles.container}
          hidden={!controlVisibility.TreeView}
        >
          <h3>Tree View</h3>
          <TreeView
            ...
            showCheckboxes={true}
            treeItemActionsDisplayMode={
              TreeItemActionsDisplayMode.ContextualMenu
            }
          ...
          <PrimaryButton
            onClick={() => {
              this.setState({ treeViewSelectedKeys: [] });
            }}
          >
            Clear selection
          </PrimaryButton>
        ...
        <div
          id="PaginationDiv"
          className={styles.container}
          hidden={!controlVisibility.Pagination}
        >
          <Pagination
            currentPage={3}
        ...
        <div
          id="FieldCollectionDataDiv"
          className={styles.container}
          hidden={!controlVisibility.FieldCollectionData}
        >
          <FieldCollectionData
        ...
        <div
          id="DashboardDiv"
          className={styles.container}
          hidden={!controlVisibility.Dashboard}
        >
          <Dashboard
            widgets={[
              {
        ...
        <div
          id="ToolbarDiv"
          className={styles.container}
          hidden={!controlVisibility.Toolbar}
        >
          <div>
          ...
          <div>
            Selected filter IDs: {this.state.selectedFilters.join(", ")}
          </div>
          <PrimaryButton
            text="Toggle filter1"
            onClick={() => this.toggleToolbarFilter("filter1")}
          />
          <PrimaryButton
            text="Toggle filter2"
            onClick={() => this.toggleToolbarFilter("filter2")}
          />
        </div>
        <div
          id="AnimatedDialogDiv"
          className={styles.container}
          hidden={!controlVisibility.animatedDialog}
        >
          ...
          <PrimaryButton
            text="Show animated dialog with icon"
            onClick={() => {
        ...
        <div
          id="LocationPickerDiv"
          className={styles.container}
          hidden={!controlVisibility.LocationPicker}
        >
          <LocationPicker
            context={this.props.context}
            label="Location"
        ...
        <div
          ...
          className={styles.container}
          hidden={!controlVisibility.ModernTaxonomyPicker}
        >
        ...
        <div
          id="AdaptiveCardHostDiv"
          className={styles.container}
          hidden={!controlVisibility.adaptiveCardHost}
        >
        ...
        <div
          id="VariantThemeProviderDiv"
          className={styles.container}
          hidden={!controlVisibility.VariantThemeProvider}
        >
        ...
        <div
          id="EnhancedThemeProviderDiv"
          className={styles.container}
          hidden={!controlVisibility.EnhancedThemeProvider}
        >
        ...
        <div
          id="AdaptiveCardDesignerHostDiv"
          className={styles.container}
          hidden={!controlVisibility.adaptiveCardDesignerHost}
        >
        ...
        <div
          id="TaxonomyTreeDiv"
          className={styles.container}
          hidden={!controlVisibility.TaxonomyTree}
        >
        ...
        <div
          id="TestControlDiv"
          className={styles.container}
          hidden={!controlVisibility.TestControl}
        >
          <h3>Monaco Editor</h3>
          <TestControl
            context={this.props.context}
        ...
        <div
          id="UploadFilesDiv"
          className={styles.container}
          hidden={!controlVisibility.UploadFiles}
        >
          <h3>Upload Files</h3>
          <EnhancedThemeProvider
            theme={this.props.themeVariant}
  ...
  private renderCustomTreeItem(item: ITreeItem): JSX.Element {
    return (
      <span>
        {item.iconProps && (
          <i
            className={"ms-Icon ms-Icon--" + item.iconProps.iconName}
